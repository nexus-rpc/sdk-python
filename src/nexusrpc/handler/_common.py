...
class OperationContext(ABC):
    ...
    task_cancellation: OperationTaskCancellation = field(kw_only=True)
    """
...
class StartOperationContext(OperationContext):
    ...
    callback_url: Optional[str] = field(default=None, kw_only=True)
    """
    ...
    callback_headers: Mapping[str, str] = field(default_factory=dict, kw_only=True)
    """
    Optional header fields set by the caller to be attached to the callback request when an
    asynchronous operation completes.
    """

    inbound_links: Sequence[Link] = field(default_factory=list, kw_only=True)
    """
    ...
    outbound_links: list[Link] = field(default_factory=list, kw_only=True)
    """
